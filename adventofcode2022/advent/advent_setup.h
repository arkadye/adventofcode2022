...
static const verification_test tests[] =
{
	...
	TESTCASE(day_seventeen_p1_a,3068),
	TESTCASE(day_seventeen_p2_a,1514285714288),
	DAY(seventeen,3100,1540634005751),
	TESTCASE(day_eighteen_p1_a,10),
	TESTCASE(day_eighteen_p1_b,64),
	TESTCASE(day_eighteen_p2_a,10),
	TESTCASE(day_eighteen_p2_b,58),
	DAY(eighteen,4580,2610),
	TESTCASE(day_nineteen_p1_a,33),
	TESTCASE(day_nineteen_p2_a,62),
	DAY(nineteen,1616,8990),
	TESTCASE(day_twenty_p1_a, 3),
	TESTCASE(day_twenty_p2_a, 1623178306),
	DAY(twenty,7228,4526232706281),
	...
	TESTCASE(day_twentyfive_p1_std<28901>,976),
	TESTCASE(day_twentyfive_p1_std<1>,1),
	TESTCASE(day_twentyfive_p1_std<2>,2),
	TESTCASE(day_twentyfive_p1_std<18>,3),
	TESTCASE(day_twentyfive_p1_std<19>,4),
	TESTCASE(day_twentyfive_p1_std<10>,5),
	TESTCASE(day_twentyfive_p1_std<11>,6),
	TESTCASE(day_twentyfive_p1_std<12>,7),
	TESTCASE(day_twentyfive_p1_std<28>,8),
	TESTCASE(day_twentyfive_p1_std<29>,9),
	TESTCASE(day_twentyfive_p1_std<20>,10),
	TESTCASE(day_twentyfive_p1_std<180>,15),
	TESTCASE(day_twentyfive_p1_std<190>,20),
	TESTCASE(day_twentyfive_p1_std<181192>,2022),
	TESTCASE(day_twentyfive_p1_std<1909990>, 12345),
	TESTCASE(day_twentyfive_p1_std<1121911109180>, 314159265),
	TESTCASE(day_twentyfive_p1_dts<1>, "1"),
	TESTCASE(day_twentyfive_p1_dts<2>, "2"),
	TESTCASE(day_twentyfive_p1_dts<3>, "1="),
	TESTCASE(day_twentyfive_p1_dts<4>, "1-"),
	TESTCASE(day_twentyfive_p1_dts<5>, "10"),
	TESTCASE(day_twentyfive_p1_dts<6>, "11"),
	TESTCASE(day_twentyfive_p1_dts<7>, "12"),
	TESTCASE(day_twentyfive_p1_dts<8>, "2="),
	TESTCASE(day_twentyfive_p1_dts<9>, "2-"),
	TESTCASE(day_twentyfive_p1_dts<10>, "20"),
	TESTCASE(day_twentyfive_p1_dts<15>, "1=0"),
	TESTCASE(day_twentyfive_p1_dts<20>, "1-0"),
	TESTCASE(day_twentyfive_p1_dts<2022>, "1=11-2"),
	TESTCASE(day_twentyfive_p1_dts<12345>, "1-0---0"),
	TESTCASE(day_twentyfive_p1_dts<314159265>, "1121-1110-1=0"),
	TESTCASE(day_twentyfive_p1_a,"2=-1=0"),
	DAY(twentyfive, "121=2=1==0=10=2-20=2", "MERRY CHRISTMAS!")
};
